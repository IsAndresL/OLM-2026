      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Administración de envíos y guías</p>
          </div>
        </div>
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-700">📦 Esta sección se implementa en la <strong>Fase 2</strong>. Incluirá creación, edición, asignación de guías y generación de etiquetas PDF.</p>
        </div>
      </div>
    </Layout>
  );
