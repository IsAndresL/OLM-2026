        ...
        <div className="flex flex-wrap gap-3">
          {selectedIds.length > 0 && (
            <button 
              ...
              className="bg-brand-navy hover:bg-gray-800 text-white px-5 py-2.5 rounded-2xl text-xs font-black uppercase tracking-widest transition-all flex items-center gap-2 shadow-lg shadow-brand-navy/20 active:scale-95"
            >
          ...
          <button 
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-2xl text-xs font-black uppercase tracking-widest transition-all flex items-center gap-2 shadow-lg shadow-emerald-600/20 active:scale-95"
          >
            <FileSpreadsheet size={16} /> Excel
          </button>
          <button 
            onClick={() => setIsModalCrearOpen(true)} 
            className="bg-brand-primary hover:bg-brand-light text-white px-6 py-3 rounded-2xl text-xs font-black uppercase tracking-widest shadow-xl shadow-brand-primary/30 transition-all flex items-center gap-2 active:scale-95"
          >
                  ...
                  <td className="p-4 text-right">
                    <div className="flex items-center justify-end gap-1">
                      <button 
                        ...
                        className="p-2 text-gray-400 hover:text-brand-primary hover:bg-brand-light/10 rounded-xl transition-all" 
                        title="Etiqueta PDF"
                      >
                        <FileDown size={18} />
                      </button>
                      ...
                      {(['registrado', 'direccion_incorrecta', 'no_contesto', 'reagendar'].includes(g.estado_actual)) && (
                        <button 
              ...
              <form id="crearGuiaForm" onSubmit={crearGuia} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="text" name="barrio" className="w-full p-2 border border-gray-300 rounded-lg" />
                  </div>
                  <div>
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 border-t border-gray-100 flex justify-end gap-3 bg-gray-50 rounded-b-3xl">
              <button 
                ...
                className="px-5 py-2.5 text-xs font-black uppercase tracking-widest text-gray-700 bg-white border-2 border-gray-200 hover:border-brand-primary/30 hover:bg-gray-50 rounded-2xl flex items-center gap-2 transition-all active:scale-95"
              >
